...
<head>
  ...
  <title>Surat - Data Disposisi Surat</title>
                ...
                <div class="table-responsive p-3">
                  <table class="table align-items-center table-flush table-hover" id="dataTableHover">
                    ...
                    <tbody>
                      ...
                      $data = mysqli_query($koneksi, "SELECT * FROM tb_disposisi, tb_sm WHERE id_sm = sm_id ORDER BY id_disposisi ASC");
                      ...
                      <tr>
                        ...
                        <td>
                          <small><?php echo $row['disposisi']; ?> - ( <b><?php echo $row['tujuan_disposisi']; ?></b> )</small>
                        </td>
                        <td>
