...
$query = "INSERT INTO tb_sk (nomor_agenda, nomor_sk, tgl_keluar, tgl_sk, penerima_sk, perihal_sk, lampiran_sk, status, tindakan, dari_disposisi) 
              VALUES ('$nomorAgenda', '$nomorSuratKeluar', '$tanggalKeluar', '$tanggalSuratKeluar', '$penerima', '$perihal', '$lampiran', '1', '$tindakan', '$idp')";
