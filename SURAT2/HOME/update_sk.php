...
$query = "UPDATE tb_sk SET nomor_agenda='$nomorAgenda', nomor_sk='$nomorSuratKeluar', tgl_keluar='$tanggalKeluar', tgl_sk='$tanggalSuratKeluar', penerima_sk='$penerima', perihal_sk='$perihal', lampiran_sk='$lampiran', tindakan='$tindakan', dari_disposisi='$idp' WHERE id_sk=$surat_id";
