      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Data Surat Keluar <?php echo $_SESSION['jabatan']; ?></h1>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="./index.php">Home</a></li>
              <li class="breadcrumb-item">Surat Keluar <?php echo $_SESSION['jabatan']; ?></li>
              <li class="breadcrumb-item active" aria-current="page">Data Surat Keluar <?php echo $_SESSION['jabatan']; ?></li>
            </ol>
          </div>
                ...
                <div class="table-responsive p-3">
                  <table class="table align-items-center table-flush table-hover" id="dataTableHover">
                    ...
                    <tbody>
                      ...
                      $data = mysqli_query($koneksi, "SELECT * FROM tb_sk WHERE dari_disposisi = '$id' ORDER BY id_sk DESC");
            ...
            <div class="modal-dialog modal-lg" role="document">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <form method="POST" action="proses_sk1.php" enctype="multipart/form-data">
                    <?php
          ...
          <div class="modal fade" id="editModal<?php echo $rk['id_sk']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <form method="POST" action="update_sk1.php" enctype="multipart/form-data">
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  ...
                  <?php if ($rk1['status'] == 0) { ?>
                    <hr>
                    <form method="POST" action="upload_ulang1.php" enctype="multipart/form-data">
                  ...
                  <?php }elseif ($rk1['status'] == 3) { ?>
                    <?php if ($rk1['status_arsip'] == 0) { ?>
                      <hr>
                      <form method="POST" action="proses_arsip_k.php">
                        <input type="hidden" name="idsk" value="<?php echo $rk1['id_sk']; ?>">
                        <div class="form-group">
                    ...
                    <?php }elseif ($rk1['status_arsip'] == 1) { ?>
                      <center><span class="badge badge-primary"><i class="fas fa-check"></i> File Surat Keluar Sudah Diarsip</span></center>
                    <?php } ?>
                  <?php } ?>
                </div>
